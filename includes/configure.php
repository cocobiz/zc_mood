 ...
 * File Built by zc_install on 2014-06-18 11:21:42
 */
...
define('HTTPS_SERVER', 'https://pro');

// Use secure webserver for checkout procedure?
define('ENABLE_SSL', 'false');

// NOTE: be sure to leave the trailing '/' at the end of these lines if you make changes!dss
// * DIR_WS_* = Webserver directories (virtual/URL)
// these paths are relative to top of your webspace ... (ie: under the public_html or httpdocs folder)
define('DIR_WS_CATALOG', '/zc_mood/');
define('DIR_WS_HTTPS_CATALOG', '/zc_mood/');
