...
class shoppingCart extends base
{
                        ...
                        while (list ($option, $value) = each($this->contents[$products_id]['attributes'])) {
                            ...
                            $sql = "insert into " . TABLE_CUSTOMERS_BASKET_ATTRIBUTES . "
                                    (customers_id, products_id, products_options_id,
                                     ...
                                     values ('" . (int) $_SESSION['customer_id'] . "', '" . zen_db_input($products_id) . "', '" . $option . "', '" . $value . "', '" . $attr_value . "', '" . $products_options_sort_order . "')";
     ...
     *
     * @param
     *            boolean whether to reset customers db basket
     * @return void
     * @global object access to the db object
     */
     ...
     *
     * @param
     *            integer the product ID of the item to be added
     * @param
     *            decimal the quantity of the item to be added
     * @param
     *            array any attributes that are attache to the product
     * @param
     *            boolean whether to add the product to the notify list
     * @return void
     * @global object access to the db object
     ...
     *
     * @param
     *            mixed product ID of item to update
     * @param
     *            decimal the quantity to update the item to
     * @param
     *            array product atributes attached to the item
     * @return void
     * @global object access to the db object
     */
     ...
     *
     * @param
     *            mixed product ID of item to check
     ...
     *
     * @param
     *            mixed product ID of item to remove
     * @return void
     * @global object access to the db object
     */
     ...
     *
     * @param
     *            mixed the product ID of the item to check
     ...
     *
     * @param
     *            boolean whether to check if cart contents are valid
     * @return array
     */
     ...
     *
     * @param
     *            boolean whether to test for Gift Vouchers only
     * @return string
     */
     ...
     *
     * @param
     *            boolean product id of item to check
     * @return deciaml
     */
    ...
    function actionNotify($goto, $parameters)
    {
        ...
        if ($_SESSION['customer_id']) {
            if (isset($_GET['products_id'])) {
                ...
                zen_redirect(zen_href_link($_GET['main_page'], zen_get_all_get_params(array(
                    'action',
                    'notify',
                    'main_page'
                ))));
