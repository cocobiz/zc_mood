 ...
 */
if (file_exists($base_dir . $loader_file)) include($base_dir . $loader_file);     //加载核心配置文件 config.core.php
if ($loader_dir = dir(DIR_WS_INCLUDES . 'auto_loaders')) {                        //加载其它配置文件 config.xxx.php
