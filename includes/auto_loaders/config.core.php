...
if (!defined('USE_PCONNECT')) define('USE_PCONNECT', 'false');	//mysql 持久连接?
/**
 *
 ...
 */
  ...
  $autoLoadConfig[0][] = array('autoType'=>'classInstantiate',
                               ...
                               'checkInstantiated'=>true);												 // cache the the 'select sql query result' every time. $queryCache = array('select ..', $result) 
 ...
 */
  $autoLoadConfig[10][] = array('autoType'=>'init_script',
                                'loadFile'=> 'init_file_db_names.php');									// constant : table name, file name
  $autoLoadConfig[10][] = array('autoType'=>'init_script',
                                'loadFile'=>'init_database.php');										// $db = new queryFactory();
/**
 * Breakpoint 20.
 *
 ...
 */
  $autoLoadConfig[30][] = array('autoType'=>'classInstantiate',
                                'className'=>'cache',
                                'objectName'=>'zc_cache');												// cache: file, database, none. Cache the sql query
/**
 * Breakpoint 40.
 *
 ...
 */
  $autoLoadConfig[40][] = array('autoType'=>'init_script',
                                'loadFile'=> 'init_db_config_read.php');								// load admin setting from DB
/**
 * Breakpoint 50.
 *
 * $sniffer = new sniffer();										
 ...
 */
  $autoLoadConfig[50][] = array('autoType'=>'classInstantiate',
                                'className'=>'sniffer',
                                'objectName'=>'sniffer');												// Object: check table name, filed name, field type
  $autoLoadConfig[50][] = array('autoType'=>'init_script',
                                'loadFile'=> 'init_gzip.php');
  $autoLoadConfig[50][] = array('autoType'=>'init_script',
                                'loadFile'=> 'init_sefu.php');											// search_engine_friendly_urls
  
  // we do not need forum, so kill the phpBB object
  /*
  $autoLoadConfig[50][] = array('autoType'=>'classInstantiate',
                                'className'=>'phpBB',
                                'objectName'=>'phpBB');
 ...
 */
  $autoLoadConfig[60][] = array('autoType'=>'init_script',
                                'loadFile'=> 'init_general_funcs.php');									// general API
  $autoLoadConfig[60][] = array('autoType'=>'init_script',
                                'loadFile'=> 'init_tlds.php');											// set cookie domain
/**
 * Breakpoint 70.
 *
 ...
 */
  ...
  $autoLoadConfig[100][] = array('autoType'=>'init_script',
                                 'loadFile'=> 'init_sanitize.php');										// $_GET $_POST $_REQUEST $_GET['main_page'] $_SESSION $_COOKIE
/**
 * Breakpoint 110.
 *
 ...
 */
  $autoLoadConfig[110][] = array('autoType'=>'init_script',
                                 'loadFile'=> 'init_languages.php');									// set and load current language/template folder	$_SESSION['language']
  $autoLoadConfig[110][] = array('autoType'=>'init_script',
 ...
 */
  ...
  $autoLoadConfig[120][] = array('autoType'=>'init_script',
                                 'loadFile'=> 'init_currencies.php');									// $_SESSION['currency']
/**
 * Breakpoint 130.
 *
 ...
 */
  ...
  $autoLoadConfig[130][] = array('autoType'=>'init_script',
                                 'loadFile'=> 'init_customer_auth.php');								// use for maintenance and approve auth
/**
 * Breakpoint 140.
 *
 ...
 */
  $autoLoadConfig[140][] = array('autoType'=>'init_script',
                                 'loadFile'=> 'init_cart_handler.php');									// cart action
/**
 * Breakpoint 150.
 *
 ...
 */
  $autoLoadConfig[150][] = array('autoType'=>'init_script',
                                 'loadFile'=> 'init_special_funcs.php');								// who_is_online  specials featured ...
/**
 * Breakpoint 160.
 *
 ...
 */
  ...
  $autoLoadConfig[160][] = array('autoType'=>'init_script',
                                 'loadFile'=> 'init_category_path.php');								// $cPath   $cPath_array  $this_is_home_page
/**
 * Breakpoint 170.
 *
 ...
 */
  $autoLoadConfig[170][] = array('autoType'=>'init_script',
                                 'loadFile'=> 'init_add_crumbs.php');									// add crumbs
/**
 * Breakpoint 180.
 *
 ...
 */
  $autoLoadConfig[180][] = array('autoType'=>'init_script',
                                 'loadFile'=> 'init_header.php');										// messageStack
?>